const translations = {
    'en': {
        ...
        'bulkImportOpenBtn': 'Bulk Import Keys',
        ...
        'bulkImportInputDuplicate': 'Duplicate in input: {0}',
        'bulkImportDbDuplicate': 'Duplicate in database: {0}',
    ...
    'zh-CN': {
        ...
        'bulkImportInputDuplicate': '输入重复: {0}',
        'bulkImportDbDuplicate': '数据库重复: {0}',
    ...
    'zh-TW': {
        ...
        'bulkImportInputDuplicate': '輸入重複: {0}',
        'bulkImportDbDuplicate': '資料庫重複: {0}',
    ...
    'ja': {
        ...
        'bulkImportSummary': '成功: {0}、失敗: {1}',
        'bulkImportInputDuplicate': '入力重複: {0}',
        'bulkImportDbDuplicate': 'データベース重複: {0}',
        'bulkImportFailedItems': '失敗項目:',
